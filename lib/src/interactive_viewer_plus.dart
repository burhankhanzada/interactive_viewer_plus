// Copied from flutter/lib/src/widgets/interactive_viewer.dart
...
/// See also:
///
///   * [InteractiveViewerPlus.builder], whose builder is of this type.
...
class InteractiveViewerPlus extends StatefulWidget {
  ...
  ///
  /// Passed with the [InteractiveViewerPlus.builder] constructor. Otherwise, the
  ...
  ///
  /// If the [InteractiveViewerPlus.builder] constructor is used, then this will be
  ...
  static Vector3 getNearestPointInside(Vector3 point, Quad quad) {
    ...
    final List<Vector3> closestPoints = <Vector3>[
      InteractiveViewerPlus.getNearestPointOnLine(
        point,
        quad.point0,
        quad.point1,
      ),
...
/// See also:
///
///  * [InteractiveViewerPlus.transformationController] for detailed documentation
///    on how to use TransformationController with [InteractiveViewerPlus].
...
Quad _getAxisAlignedBoundingBoxWithRotation(Rect rect, double rotation) {
  ...
  return InteractiveViewerPlus.getAxisAlignedBoundingBox(boundariesRotated);
}
...
Offset _exceedsBy(Quad boundary, Quad viewport) {
  ...
  for (final Vector3 point in viewportPoints) {
    final Vector3 pointInside = InteractiveViewerPlus.getNearestPointInside(
      point,
      boundary,
    );
...
/// This enum is used to specify the behavior of the [InteractiveViewerPlus] when
